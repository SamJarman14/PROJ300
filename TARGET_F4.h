    ...
    #define MEMS_SDA    PB_11  
    #define MEMS_SCL    PB_10
    #define MEMS_FREQ   400000
    ...
    #define MATRIX_MOSI PC_12
    #define MATRIX_MISO PC_11
    #define MATRIX_SCLK PC_10
    ...
    #define ENV_SCLK PB_3
    #define ENV_CS   PB_2

    #define DIP0_PIN    PF_12
    #define DIP1_PIN    PF_13
    #define DIP2_PIN    PF_14
    #define DIP3_PIN    PF_15
